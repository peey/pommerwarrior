...
"""
State = collections.namedtuple("State", ["has_bomb", "enemy_nearby", "is_surrounded", "los_bomb", "has_ammo", "can_kick", "nearest_enemy", "nearest_powerup"])

component_state_space = State([True, False], [True, False], [True, False], [True, False], [True, False], [True, False], ["east", "west", "north", "south", "se", "sw", "ne", "nw", "nowhere"], ["east", "west", "north", "south", "se", "sw", "ne", "nw", "nowhere"])
